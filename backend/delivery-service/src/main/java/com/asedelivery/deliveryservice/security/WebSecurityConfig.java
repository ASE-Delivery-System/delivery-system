package com.asedelivery.deliveryservice.security;

import com.asedelivery.deliveryservice.security.jwt.AuthEntryPointJwt;
import com.asedelivery.deliveryservice.security.jwt.AuthTokenFilter;
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable()
			...
			.authorizeRequests().antMatchers("/user/auth/**").hasRole("DISPATCHER")
			 // .antMatchers("/delivery/**").hasRole("DELIVERER")
